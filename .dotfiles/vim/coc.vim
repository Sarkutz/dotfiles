...
if has("patch-8.1.1564")
  ...
  " Do not use reuse the number's column for signs.
  set signcolumn=auto
...
" function! s:has_ulitisnip()
" 	" g:ulti_expand_res valid after call to UltiSnips#ExpandSnippet()
" 	return g:ulti_expand_res == 1
" endfunction
...
xmap <leader>cvf  <Plug>(coc-format-selected)
nmap <leader>cvf  <Plug>(coc-format-selected)
